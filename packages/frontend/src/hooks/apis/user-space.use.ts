...
// 分页获取所有用户的最新用户空间数据
export function useAllLatestUserSpaceData(
  params?: { page?: number; limit?: number },
  options?: Omit<
    UseQueryOptions<PaginatedResponse<UserSpace.UserSpaceVO>>,
    "queryKey" | "queryFn"
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const [data, error] = await parseResponse(async () =>
        userSpaceApi.getAllLatestUserSpaceData(params),
      );
      if (error) {
        throw new Error(error.message);
      }
...
// 根据等级范围查询用户空间数据
export function useUserSpaceDataByLevelRange(
  params?: {
    minLevel?: number;
    maxLevel?: number;
    page?: number;
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const [data, error] = await parseResponse(async () =>
        userSpaceApi.getUserSpaceDataByLevelRange(params),
      );
      if (error) {
        throw new Error(error.message);
      }
...
// 根据认证状态查询用户空间数据
export function useVerifiedUserSpaceData(
  params?: { page?: number; limit?: number },
  options?: Omit<
    UseQueryOptions<PaginatedResponse<UserSpace.UserSpaceVO>>,
    "queryKey" | "queryFn"
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const [data, error] = await parseResponse(async () =>
        userSpaceApi.getVerifiedUserSpaceData(params),
      );
      if (error) {
        throw new Error(error.message);
      }
...
// 搜索用户空间数据
export function useSearchUserSpaceData(
  keyword: string,
  params?: { page?: number; limit?: number },
  options?: Omit<
    UseQueryOptions<PaginatedResponse<UserSpace.UserSpaceVO>>,
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const [data, error] = await parseResponse(async () =>
        userSpaceApi.searchUserSpaceData(keyword, params),
      );
      if (error) {
        throw new Error(error.message);
      }
...
// 获取用户空间数据统计信息
export function useUserSpaceStats(
  mid?: number,
  options?: Omit<
    UseQueryOptions<{
      totalRecords: number;
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const [data, error] = await parseResponse(async () =>
        userSpaceApi.getUserSpaceStats(mid),
      );
      if (error) {
        throw new Error(error.message);
      }
...
export function useUserSpaceSyncMutation(
  options?: UseMutationOptions<
    SyncResponse,
    unknown,
    { mids?: number[]; cookie?: string }
  >,
) {
  ...
  return useMutation({
    ...
    onSuccess: async () => {
      // 同步完成后，刷新相关数据
      await queryClient.invalidateQueries({ queryKey: ["user-space"] });
    },
    ...options,
  });
}
...
export function useLatestUserSpaceDataSafe(
  mid: number,
  options?: Omit<
    UseQueryOptions<[UserSpace.UserSpaceVO | null, Http.ErrorResponse | null]>,
    "queryKey" | "queryFn"
  >,
) {
  return useQuery({
    ...
    queryFn: async () =>
      parseResponse(async () => userSpaceApi.getLatestUserSpaceData(mid)),
    ...options,
  });
}

export function useUserSpaceDataByMidSafe(
  mid: number,
  params?: { page?: number; limit?: number },
  options?: Omit<
    UseQueryOptions<
      [
        PaginatedResponse<UserSpace.UserSpaceVO> | null,
...
export function useAllLatestUserSpaceDataSafe(
  params?: { page?: number; limit?: number },
  options?: Omit<
    UseQueryOptions<
      [
  ...
  return useQuery({
    ...
    queryFn: async () =>
      parseResponse(async () => userSpaceApi.getAllLatestUserSpaceData(params)),
    ...options,
  });
}

export function useSearchUserSpaceDataSafe(
  keyword: string,
  params?: { page?: number; limit?: number },
  options?: Omit<
    UseQueryOptions<
